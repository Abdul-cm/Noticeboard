...
$query=mysqli_query($con,"select id from tbladmin where AdminUserName='$adminid' and   AdminPassword='$cpassword'");
$row=mysqli_fetch_array($query);
if($row>0){
$ret=mysqli_query($con,"update tbladmin set AdminPassword='$newpassword' where AdminUserName='$adminid'");
